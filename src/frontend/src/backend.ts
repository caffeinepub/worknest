...
export class Backend implements backendInterface {
    ...
    async addWorkspace(arg0: string, arg1: bigint, arg2: string, arg3: Array<string>, arg4: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addWorkspace(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async bookWorkspace(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.bookWorkspace(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyListings(): Promise<Array<Workspace>> {
        if (this.processError) {
            try {
